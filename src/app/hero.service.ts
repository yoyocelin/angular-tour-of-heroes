...
export class HeroService {
  ...
  getHeroes(): Observable<Hero[]> {//to observe asynchronous calls 
    ...
    return this.http.get<Hero[]>(this.heroesUrl)//an httpClient returns an RxJS Observable of something
      .pipe(
        tap(_ => this.log('fetched heroes')),
        catchError(this.handleError<Hero[]>('getHeroes', []))//catching the error
      )
    //this HttpClient.get() returns an Observable<Hero[]>
  }
  ...
  getHero(id: number): Observable<Hero> {
    ...
    //return of(hero);
    return this.http.get<Hero>(url).pipe(//returns an Observable of one hero
  ...
  //special headers for options, post,put data
  httpOptions = {
  ...
  deleteHero(id: number): Observable<Hero> {
    ...
    return this.http.delete<Hero>(url, this.httpOptions).pipe(//still sending httpOptions
